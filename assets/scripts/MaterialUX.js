...
/* jQuery('#myModal').foundation('reveal', 'open', {
    url: 'http://exp.kwiki.co.il/מיוחד:העלאה',
...
//jQuery('#myModal').foundation('reveal', 'open', 'http://exp.kwiki.co.il/מיוחד:העלאה');
...
if (typeof (HotCat) != 'undefined') {
  HotCat.messages.commit      = 'שמירה';
  HotCat.messages.ok          = 'אישור';
  HotCat.messages.cancel      = 'ביטול';
  HotCat.messages.multi_error = 'למרבה הצער ארעה תקלה, והשינויים שביצעת לא נשמרו. אתך הסליחה.';

  HotCat.categories  = 'קטגוריות';

  HotCat.engine_names.searchindex = 'חיפוש';
  HotCat.engine_names.pagelist    = 'רשימת דפים';
  HotCat.engine_names.combined    = 'חיפוש מורכב';
  HotCat.engine_names.subcat      = 'תת קטגוריות';
  HotCat.engine_names.parentcat   = 'קטגוריות אב';
 
  HotCat.tooltips.change = 'שינוי';
  HotCat.tooltips.remove = 'הסרה';
  HotCat.tooltips.add = 'הוספת קטגוריה';
  HotCat.tooltips.restore = 'ביטול שינויים';
  HotCat.tooltips.undo = 'ביטול שינויים';
  HotCat.tooltips.down = 'פתיחה לעריכה והצגת תת קטגוריות';
  HotCat.tooltips.up = 'פתיחה לעריכה והצגת קטגוריות אב';
